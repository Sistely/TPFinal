...
namespace API_TP_Final.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public String Index()
        {
            var usuarios = _context.Usuarios.Select(user => new Usuario
            {
                Id = user.Id,
                Nome = user.Nome,
                Senha = user.Senha,
        ...
        {
            var usuario = await _context.Usuarios.FirstOrDefaultAsync(n => n.Id == id);
            return Json(usuario);
        }
        ...
        public async Task<IActionResult> Edit(int id, [FromBody] Usuario usuario)
        {
            ...
            if (ModelState.IsValid)
            {
                var userAntigo = await _context.Usuarios.FirstOrDefaultAsync(n => n.Id == id);

                userAntigo.Nome = usuario.Nome;
                userAntigo.Senha = usuario.Senha;
                userAntigo.Status = usuario.Status;       
